...
[^svd]: Methods for `eigen()` and `svd()` decompositions are included in **tidybiplot** for illustration. In practice, the interpretation of their output depends on the theoretical framework in which they are used.
