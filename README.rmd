...
To keep **ordr** from growing out of control, recovery methods only for S3 classes produced by high-priority packages are included.[^priority]
The auxiliary package [**ordr.extra**](https://github.com/corybrunson/ordr.extra) provides methods for several additional ordination models---and has room for several more!

[^priority]: `installed.packages(priority = "high")`
