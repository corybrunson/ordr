...
title = NULL
upper = 
  list(continuous = "cor", combo = "box_no_facet", discrete = "count", na = "na")
lower = 
  list(continuous = "points", combo = "facethist", discrete = "facetbar", na = "na")
diag = 
...
columns <-
  GGally:::fix_column_values(data, columns, columnLabels, "columns", "columnLabels")
