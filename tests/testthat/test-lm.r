...
test_that("'as_tbl_ord()' coerces 'lm' objects", {
  expect_true(is.tbl_ord(as_tbl_ord(fit_lm0)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_lm1)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_lm2)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_lm3)))
})
...
test_that("'as_tbl_ord()' coerces 'glm' objects", {
  expect_true(is.tbl_ord(as_tbl_ord(fit_glm0)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_glm1)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_glm2)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_glm3)))
})
...
test_that("'as_tbl_ord()' coerces 'mlm' objects", {
  expect_true(is.tbl_ord(as_tbl_ord(fit_mlm0)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_mlm1)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_mlm2)))
  expect_true(is.tbl_ord(as_tbl_ord(fit_mlm3)))
})
