...
The goal of this guide is to help contributors to **ordr** plan their
...
Note that **ordr** is released with a [Contributor Code of
Conduct](CODE_OF_CONDUCT.md). By contributing, you agree to its terms.

This guide was copied from [that of
**ggalluvial**](https://github.com/corybrunson/ggalluvial/blob/main/CONTRIBUTING.md),
