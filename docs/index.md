...
([`stats::cmdscale()`](https://rdrr.io/r/stats/cmdscale.html)) and
principal components analysis
([`stats::prcomp()`](https://rdrr.io/r/stats/prcomp.html) and
[`stats::princomp()`](https://rdrr.io/r/stats/princomp.html)) in the
**stats** package distributed with base R, across widely-used
implementations of linear discriminant analysis
...
produces a tibble describing the model components, in this case the
principal coordinates, which is suitable for scree plotting:
...
![](reference/figures/README-model%20components%20and%20scree%20plot-1.png)

Following **ggplot2**, the
[`fortify()`](https://ggplot2.tidyverse.org/reference/fortify.html)
method row-binds the factor tibbles with an additional `.matrix` column.
This is used by [`ggbiplot()`](reference/ggbiplot.md) to redirect row-
and column-specific plot layers to the appropriate subsets:[^8]
...
![](reference/figures/README-interpolative%20biplot-1.png)
...
![](reference/figures/README-predictive%20biplot-1.png)
...
[^4]: Some regression and clustering models, like classical [linear
    ...
    and [*k*-means
    clustering](http://joelcadwell.blogspot.com/2015/08/matrix-factorization-comes-in-many.md),
    ...
    and the cluster assignments, respectively. Methods for
    [`stats::lm()`](https://rdrr.io/r/stats/lm.html) and
    [`stats::kmeans()`](https://rdrr.io/r/stats/kmeans.html) are
    implemented for the sake of novelty and instruction but are not
